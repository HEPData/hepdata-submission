...
void makeSimpleExample(){
  ...
  example->mkdir("Sys4");
  example->cd("Sys4");
  TH1F* background1sys4high = new TH1F("bkg1Syst4High","background 1 histogram (pb)", 2,1,2);
  TH1F* background1sys4low = new TH1F("bkg1Syst4Low","background 1 histogram (pb)", 2,1,2);
  TH1F* background2sys4high = new TH1F("bkg2Syst4High","background 2 histogram (pb)", 2,1,2);
  TH1F* background2sys4low = new TH1F("bkg2Syst4Low","background 2 histogram (pb)", 2,1,2);
  background1sys4high->SetBinContent(1,120);
  background1sys4low->SetBinContent(1,80);
  background2sys4high->SetBinContent(2,110);
  background2sys4low->SetBinContent(2,90);
